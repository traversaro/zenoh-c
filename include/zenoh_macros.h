...
typedef struct z_moved_alloc_layout_t { struct z_owned_alloc_layout_t* ptr; } z_moved_alloc_layout_t;
typedef struct z_moved_buf_alloc_result_t { struct z_owned_buf_alloc_result_t* ptr; } z_moved_buf_alloc_result_t;
...
typedef struct z_moved_chunk_alloc_result_t { struct z_owned_chunk_alloc_result_t* ptr; } z_moved_chunk_alloc_result_t;
...
typedef struct z_moved_memory_layout_t { struct z_owned_memory_layout_t* ptr; } z_moved_memory_layout_t;
...
typedef struct z_moved_shm_client_t { struct z_owned_shm_client_t* ptr; } z_moved_shm_client_t;
typedef struct z_moved_shm_client_storage_t { struct z_owned_shm_client_storage_t* ptr; } z_moved_shm_client_storage_t;
typedef struct z_moved_shm_t { struct z_owned_shm_t* ptr; } z_moved_shm_t;
typedef struct z_moved_shm_mut_t { struct z_owned_shm_mut_t* ptr; } z_moved_shm_mut_t;
typedef struct z_moved_shm_provider_t { struct z_owned_shm_provider_t* ptr; } z_moved_shm_provider_t;
...
#define z_move(x) \
    _Generic((x), \
        z_owned_alloc_layout_t : (z_moved_alloc_layout_t){&#x}, \
        z_owned_buf_alloc_result_t : (z_moved_buf_alloc_result_t){&#x}, \
        z_owned_bytes_t : (z_moved_bytes_t){&#x}, \
        z_owned_bytes_writer_t : (z_moved_bytes_writer_t){&#x}, \
        z_owned_chunk_alloc_result_t : (z_moved_chunk_alloc_result_t){&#x}, \
        z_owned_closure_hello_t : (z_moved_closure_hello_t){&#x}, \
        z_owned_closure_owned_query_t : (z_moved_closure_owned_query_t){&#x}, \
        z_owned_closure_query_t : (z_moved_closure_query_t){&#x}, \
        z_owned_closure_reply_t : (z_moved_closure_reply_t){&#x}, \
        z_owned_closure_sample_t : (z_moved_closure_sample_t){&#x}, \
        z_owned_closure_zid_t : (z_moved_closure_zid_t){&#x}, \
        z_owned_condvar_t : (z_moved_condvar_t){&#x}, \
        z_owned_config_t : (z_moved_config_t){&#x}, \
        z_owned_encoding_t : (z_moved_encoding_t){&#x}, \
        z_owned_fifo_handler_query_t : (z_moved_fifo_handler_query_t){&#x}, \
        z_owned_fifo_handler_reply_t : (z_moved_fifo_handler_reply_t){&#x}, \
        z_owned_fifo_handler_sample_t : (z_moved_fifo_handler_sample_t){&#x}, \
        z_owned_hello_t : (z_moved_hello_t){&#x}, \
        z_owned_keyexpr_t : (z_moved_keyexpr_t){&#x}, \
        z_owned_memory_layout_t : (z_moved_memory_layout_t){&#x}, \
        z_owned_mutex_t : (z_moved_mutex_t){&#x}, \
        z_owned_publisher_t : (z_moved_publisher_t){&#x}, \
        z_owned_query_t : (z_moved_query_t){&#x}, \
        z_owned_queryable_t : (z_moved_queryable_t){&#x}, \
        z_owned_reply_t : (z_moved_reply_t){&#x}, \
        z_owned_reply_err_t : (z_moved_reply_err_t){&#x}, \
        z_owned_ring_handler_query_t : (z_moved_ring_handler_query_t){&#x}, \
        z_owned_ring_handler_reply_t : (z_moved_ring_handler_reply_t){&#x}, \
        z_owned_ring_handler_sample_t : (z_moved_ring_handler_sample_t){&#x}, \
        z_owned_sample_t : (z_moved_sample_t){&#x}, \
        z_owned_session_t : (z_moved_session_t){&#x}, \
        z_owned_shm_client_t : (z_moved_shm_client_t){&#x}, \
        z_owned_shm_client_storage_t : (z_moved_shm_client_storage_t){&#x}, \
        z_owned_shm_t : (z_moved_shm_t){&#x}, \
        z_owned_shm_mut_t : (z_moved_shm_mut_t){&#x}, \
        z_owned_shm_provider_t : (z_moved_shm_provider_t){&#x}, \
        z_owned_slice_t : (z_moved_slice_t){&#x}, \
        z_owned_slice_map_t : (z_moved_slice_map_t){&#x}, \
        z_owned_source_info_t : (z_moved_source_info_t){&#x}, \
        z_owned_string_array_t : (z_moved_string_array_t){&#x}, \
        z_owned_string_t : (z_moved_string_t){&#x}, \
        z_owned_subscriber_t : (z_moved_subscriber_t){&#x} \
    )
